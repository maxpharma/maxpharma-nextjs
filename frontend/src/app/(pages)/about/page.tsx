        ...
        <ScrollReveal>
            <div className='flex flex-col gap-4 md:gap-20'>
                ...
                <section className='space-y-2 md:space-y-4'>
                    <h1>Our Vision</h1>
                    <p>
                        To become a leading force in Nepal’s pharmaceutical
                        industry by ensuring nationwide access to high-quality,
                        affordable medicines and contributing to the
                        country&apos;s self-reliance in healthcare. 
                    </p>
                    ...
                    <div className='flex flex-col lg:flex-row gap-4 lg:gap-12'>
                        <ul className='list-disc list-inside space-y-2 lg:w-7/10 bg-secondary p-4 rounded-xl'>
                            ...
                            <li className='marker:text-primary'>
                                To build a robust supply and distribution
                                network that reaches every region, including
                                remote communities.
                            </li>
                            <li className='marker:text-primary'>
                                To establish and operate a world-class
                                manufacturing facility that meets national and
                        ...
                        <ul className='list-disc list-inside space-y-2 lg:w-7/10 bg-light-primary p-4 rounded-xl'>
                            <h1>Our Goal</h1>
                            <li className='marker:text-primary'>
                                Successfully launch our pharmaceutical
                                manufacturing unit in Ishnath-3, Rautahat within
                                the next year.
                            </li>
                            <li className='marker:text-primary'>
                                Expand our product portfolio to include a wide
                                range of essential and specialized medicines.
                            </li>
                            <li className='marker:text-primary'>
                            ...
                            <li className='marker:text-primary'>
                                ...
                                compliance, and customer satisfaction at every
