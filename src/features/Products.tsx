...
import { desc, header, image } from "framer-motion/client";
...
const Items = ({ header, title, description, image }: any) => {
    return (
        <div className='relative flex flex-col gap-4 border border-slate-300 rounded-xl max-w-sm'>
