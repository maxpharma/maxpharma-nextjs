      ...
      <div className="custom-container mt-4 flex flex-col gap-4 md:gap-16">
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="space-y-6 lg:w-6/10">
              ...
              <p>
                ...
                Nepal. Our strong nationwide network has helped us reach even
                the most remote areas, ensuring timely access to essential
                medicines.
              </p>
              <p className="max-md:hidden">
                One of our key strengths lies in our dedicated core Sales &
                Marketing team, which works tirelessly to promote our products
                and support their effective distribution. This passionate and
        ...
        <section className="space-y-4">
          ...
          <p className="text-center">
            We’ve got answers to the most common queries to help you out—quick,
