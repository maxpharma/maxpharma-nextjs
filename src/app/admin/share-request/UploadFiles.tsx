  ...
  return (
    <div className="space-y-4 my-12">
      <div className="flex gap-4">
        <button
          className={
            type === "right-share" ? "active-button" : "inactive-button"
          }
        ...
        <button
          className={
            type === "institutional-share" ? "active-button" : "inactive-button"
          }
        ...
        <button
          className={
            type === "individual-share" ? "active-button" : "inactive-button"
          }
